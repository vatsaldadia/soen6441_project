...
public class SentimentAnalyzer {
    ...
    private static final List<String> HAPPY_WORDS = Arrays.asList(
        "happy", "joy", "excellent", "great", "amazing", "wonderful", "fantastic",
        "good", "love", "awesome", "excited", "fun", "beautiful", "smile", "laugh",
        "best", "perfect", "brilliant", "excellent", "😊", "😃", "😄", "🙂", ":-)", ":)", "=)"
    );

    private static final List<String> SAD_WORDS = Arrays.asList(
        "sad", "bad", "terrible", "awful", "horrible", "worst", "hate", "disappointed",
        "unfortunate", "sorry", "fail", "poor", "crying", "unhappy", "miserable",
        "😢", "😭", "😞", "😥", ":-(", ":(", "=("
    );
    ...
    public static double analyzeDescription(String description) {
        ...
        long totalSentimentWords = Arrays.stream(words)
            .filter(word -> HAPPY_WORDS.contains(word) || SAD_WORDS.contains(word))
            .count();

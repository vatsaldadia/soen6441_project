...
public class WordStatsService {
	 ...
	 */
	public static Map<String, Long> calculateWordStats(
		List<String> descriptions
	) {
		// Concatenate all descriptions into a single string
		String allDescriptions = descriptions
			.stream()
	...
	public static Map<String, Long> computeWordStats(
		...
		Map<String, Long> sortedWordCount = calculateWordStats(allDescriptions);
